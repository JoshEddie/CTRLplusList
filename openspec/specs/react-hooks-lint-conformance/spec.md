# react-hooks-lint-conformance Specification

## Purpose

Establish a checkable contract that the codebase conforms to the React 19 / `eslint-plugin-react-hooks@7.x` rule set, with documented per-site exceptions. Created by archiving change `resolve-react-hooks-v7-lint`.
