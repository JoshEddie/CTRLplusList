...
- [ ] 13.4 New Item modal validation flow — not interactively tested
...
- [ ] 13.6 Purchase modal guest-name flow — not interactively tested
- [ ] 13.7 ImageSearch modal SearchField — code-verified; not interactively tested
- [ ] 13.8 PageSizeSelect at 44px — code-verified via `.form_field` styles
- [ ] 13.9 ListSelection validation error — not interactively tested
- [ ] 13.10 Full keyboard walkthrough across every form — deferred
- [ ] 13.11 Before/after screenshots for PR description — deferred to PR author
