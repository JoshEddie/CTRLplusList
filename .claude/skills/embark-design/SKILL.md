...
Run `/mattpocock-skills:grilling` against `proposal.md`, and against `specs/` when an earlier run already wrote it. These are settled facts — cite them, don't relitigate them.
