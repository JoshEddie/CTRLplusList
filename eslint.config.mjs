...
const eslintConfig = [
  ...
  // past 15 without an explicit per-line disable + reason.
  {
    files: [
      ...
      'app/(main)/settings/connections/page.tsx',
      'app/(main)/settings/connections/ConnectionsPage.tsx',
      'app/(main)/settings/connections/ConnectionsSection.tsx',
      'app/(main)/settings/connections/FollowingSection.tsx',
      'app/(main)/settings/connections/FollowersSection.tsx',
      'app/(main)/settings/connections/BlockedSection.tsx',
      'app/(main)/settings/connections/ConnectionRow.tsx',
      'app/(main)/settings/connections/ConnectionsActions.tsx',
      'app/(main)/user/[id]/page.tsx',
      'app/(main)/user/[id]/ProfilePage.tsx',
      'app/(main)/user/[id]/ProfileHeaderSection.tsx',
      'app/(main)/user/[id]/ProfileListsSection.tsx',
    ],
    plugins: { sonarjs },
    rules: {
