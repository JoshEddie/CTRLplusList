...
describe('Pagination', () => {
  describe('Range', () => {
    it('MidRange_RendersFirstCurrentLastOnly', () => {
      renderPagination(10, 20);
      expect(pageLabels()).toEqual(['1', '10', '20']);
    });

    it('FirstPage_RendersFirstAndLastOnly', () => {
      renderPagination(1, 20);
      expect(pageLabels()).toEqual(['1', '20']);
    });

    it('LastPage_RendersFirstAndLastOnly', () => {
      renderPagination(20, 20);
      expect(pageLabels()).toEqual(['1', '20']);
    });

    it('SinglePage_RendersOneButton', () => {
  ...
  describe('CurrentPage', () => {
    it('CurrentPage_HasAriaCurrentAndPrimaryVariant', () => {
      ...
      const other = screen.getByRole('button', { name: 'Page 5' });
  ...
  describe('Navigation', () => {
    it('ClickPageGreaterThanOne_ReplaceSetsPageParam', () => {
      ...
      expect(nav.replace).toHaveBeenCalledWith('/items?page=5');
    });
