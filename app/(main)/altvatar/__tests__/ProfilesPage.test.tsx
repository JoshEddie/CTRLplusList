/**
 * Pins `profiles-surface` — "The Altvatars page SHALL list every profile the
...
vi.mock('../ui/components/NewProfileButton', () => ({
  default: () => <button type="button">New Altvatar</button>,
}));
...
describe('ProfilesPage', () => {
  ...
  it('AuthedViewer_RendersHeaderWithNewProfileControl', async () => {
    ...
    expect(
      screen.getByRole('button', { name: 'New Altvatar' })
    ).toBeInTheDocument();
  });
